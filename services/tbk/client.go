...
func NewTbkClient() *TbkClient {
	c := &TbkClient{}
	return c
}

func (c *TbkClient) SetSession(session string) {
	c.session = session
}

func NewClientWith(credential *auth.Credentials) *TbkClient {
...
func (c *TbkClient) DoRequest(request services.TaoBaoRequest) (resp *http.Response, err error) {
...
func (c *TbkClient) paramsBuilder(request services.TaoBaoRequest) map[string]string {
...
func (c *TbkClient) QueryBuilder(request services.TaoBaoRequest) string {
...
func (c *TbkClient) sign(params map[string]string) string {
	//
	var keys []string
